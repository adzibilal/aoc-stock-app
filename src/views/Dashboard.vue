    ...
    <div>
        ...
        <a-row>
            <a-card>
                ...
                <a-button type="default" @click="changeCabang()"
                    >Ganti Cabang</a-button
                >
                <a-button type="default" @click="copyOpenShift()"
                    >Open Shift</a-button
                >
                <a-button type="default" @click="copyCloseShift()"
                    >Close Shift</a-button
                >
            </a-card>
            <br />
        </a-row>
        ...
        copyCloseShift() {
            ...
            navigator.clipboard.writeText(report).then(() => {
                ...
                this.$success({
                    ...
                    content: (
                        <div>
                            <p>Report Close Shift berhasil di salin</p>
                        </div>
                    ),
                });
            });
