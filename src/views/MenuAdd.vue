      ...
      <a-col :span="24">
        <a-card>
          ...
          >
            ...
            <a-col :span="3">
              <a-button type="danger" @click="deleteIngredient(index)">
                X
              </a-button>
            </a-col>
          </a-row>
          ...
          <a-button @click="cancelAdd" type="default" style="margin-right: 10px"
            >Batal</a-button
          >
          <a-button @click="handleAdd()" type="primary"> Simpan </a-button>
        </a-card>
      </a-col>
    </a-row>
  </div>
  ...
  methods: {
    ...
    async handleAdd() {
      ...
      if (error) {
        ...
        const ingredientsWithMenuId = this.ingredients.map((ingredient) => ({
          ...ingredient,
          menu_id: menuId,
        }));
